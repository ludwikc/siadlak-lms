  ...
  return (
    <div className="flex min-h-screen flex-col bg-discord-bg">
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="flex flex-1 flex-col justify-center px-8 py-12 md:px-16 lg:px-24">
          ...
          <div className="space-y-4">
            <button 
              ...
              className="discord-button-primary flex items-center justify-center gap-2 w-full sm:w-auto"
            >
              {isSigningIn ? (
                <>
        ...
        {/* Feature Highlights */}
        <div className="bg-discord-deep-bg p-8 md:p-12 md:w-1/3 lg:w-1/3 flex flex-col justify-center">
          <h2 className="text-2xl font-bold mb-6 text-discord-header-text">Platform Features</h2>
